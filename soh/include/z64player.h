...
typedef struct Player {
    ...
    /* 0x0151 */ s16        heldItemAction; // Item action for the item currently used [TO-DO]: Validate s8->s16 change hasn't caused any issues
    /* 0x0152 */ u8         heldItemId; // Item id for the item currently used
    /* 0x0153 */ s8         prevBoots; // previous boots from `PlayerBoots`
    /* 0x0154 */ s16        itemAction; // the difference between this and heldItemAction is unclear [TO-DO]: Validate s8->s16 change hasn't caused any issues
