...
void Player_UpdateMeleeWeaponState(Player* this, s32 newMeleeWeaponState) {
    u16 itemSfx;
    u16 voiceSfx;
...
s32 Player_TargetNonEnemy(Player* this) {
...
s32 Player_InZTargeting(Player* this) {
    return Player_InZTargetingCombat(this) || Player_TargetNonEnemy(this);
}

s32 Player_CanSwitchZTargetToEnemyFromNonEnemy(Player* this) {
    return Player_TargetEnemy(this) || Player_TargetNonEnemy(this);
}
...
s32 func_80834758(PlayState* play, Player* this) {
    ...
    if (!(this->stateFlags1 & (PLAYER_STATE1_SHIELDING | PLAYER_STATE1_ON_HORSE | PLAYER_STATE1_IN_CUTSCENE)) &&
        ...
        (this->currentShield != PLAYER_SHIELD_NONE) && !Player_IsChildWithHylianShield(this) &&
          Player_InZTargeting(this) && CHECK_BTN_ALL(sControlInput->cur.button, BTN_R)) {
...
s32 func_80834EB8(Player* this, PlayState* play) {
    if ((this->unk_6AD == 0) || (this->unk_6AD == 2)) {
        if (Player_InZTargeting(this) || (Camera_CheckValidMode(Play_GetCamera(play, 0), 7) == 0)) {
            return 1;
        }
        this->unk_6AD = 2;
    }
...
s32 func_808353D8(Player* this, PlayState* play) {
    ...
    if (!func_80834758(play, this) &&
        ...
        if (Player_InZTargeting(this) || (this->unk_6AD != 0) || (this->stateFlags1 & PLAYER_STATE1_FIRST_PERSON)) {
            if (this->unk_834 == 0) {
                this->unk_834++;
            }
            return 1;
...
s32 func_80835588(Player* this, PlayState* play) {
    if (!(this->actor.bgCheckFlags & ACTOR_BGFLAG_ON_GROUND) || LinkAnimation_Update(play, &this->upperSkelAnime)) {
        Player_SetUpperActionFunc(this, func_8083501C);
    }
...
void func_808355DC(Player* this) {
    ...
    if (!(this->skelAnime.moveFlags & 0x80) && (this->actor.bgCheckFlags & ACTOR_BGFLAG_UNKNOWN) && (sShapeYawToTouchedWall < 0x2000)) {
...
s32 func_808359FC(Player* this, PlayState* play) {
    if (LinkAnimation_Update(play, &this->upperSkelAnime)) {
        ...
        if (boomerang != NULL) {
            ...
            if (!Player_InZTargetingCombat(this)) {
                func_808355DC(this);
            }
            this->unk_A73 = 4;
...
s32 Player_GetMovementSpeedAndYaw(Player* this, f32* outSpeedTarget, s16* outYawTarget, f32 speedMode, PlayState* play) {
    if (!Player_CalcSpeedAndYawFromControlStick(play, this, outSpeedTarget, outYawTarget, speedMode)) {
        *outYawTarget = this->actor.shape.rot.y;
        ...
        } else if (Player_TargetNonEnemy(this)) {
...
void func_80837C0C(PlayState* play, Player* this, s32 arg2, f32 arg3, f32 arg4, s16 arg5, s32 arg6) {
    ...
    if (arg2 == 3) {
        ...
        if (this->stateFlags1 & PLAYER_STATE1_IN_WATER) {
            ...
            if ((this->linearVelocity > 4.0f) && !Player_InZTargetingCombat(this)) {
                this->unk_890 = 20;
...
s32 func_808382DC(Player* this, PlayState* play) {
    ...
    if (this->unk_A86 != 0) {
        ...
        if (sp68 || (this->actor.bgCheckFlags & ACTOR_BGFLAG_CRUSHED) || (sFloorType == 9) || (this->stateFlags2 & PLAYER_STATE2_FORCED_VOID_OUT)) {
            func_80832698(this, NA_SE_VO_LI_DAMAGE_S);
    ...
    if (this->actor.category == ACTORCAT_PLAYER) {
        ...
        if (!(this->stateFlags1 & PLAYER_STATE1_DEAD) && (play->transitionTrigger == TRANS_TRIGGER_OFF) && (this->csAction == 0) &&
            ...
            if (!(this->stateFlags1 & (PLAYER_STATE1_ON_HORSE | PLAYER_STATE1_IN_WATER | PLAYER_STATE1_IN_CUTSCENE)) &&
                !(this->actor.bgCheckFlags & ACTOR_BGFLAG_ON_GROUND) && (sp34 < 100) && (sYDistToFloor > 100.0f)) {
                return 0;
            }
...
s32 func_8083B998(Player* this, PlayState* play) {
    ...
    if ((this->unk_664 != NULL) &&
        ...
        this->stateFlags2 |= PLAYER_STATE2_NAVI_ALERT;
    } else if ((this->naviTextId == 0 || CVarGetInteger("gNaviOnL", 0)) && !Player_InZTargetingCombat(this) &&
...
s32 func_8083C2B0(Player* this, PlayState* play) {
    ...
    if ((play->shootingGalleryStatus == 0) && (this->currentShield != PLAYER_SHIELD_NONE) &&
        ...
        (Player_IsChildWithHylianShield(this) || (!Player_TargetNonEnemy(this) && (this->unk_664 == NULL)))) {
...
s32 func_8083F7BC(Player* this, PlayState* play) {
    ...
    if (!(this->stateFlags1 & PLAYER_STATE1_ITEM_OVER_HEAD) && (this->actor.bgCheckFlags & ACTOR_BGFLAG_UNKNOWN) && (sShapeYawToTouchedWall < 0x3000)) {
        ...
        if (!func_808332B8(this) && ((this->linearVelocity == 0.0f) || !(this->stateFlags2 & PLAYER_STATE2_DO_ACTION_CLIMB)) &&
            (sTouchedWallFlags & 0x40) && (this->actor.bgCheckFlags & ACTOR_BGFLAG_ON_GROUND) && (this->yDistToLedge >= 39.0f)) {
...
void func_80840450(Player* this, PlayState* play) {
    ...
    if (!Player_TryActionChangeList(play, this, D_808543E0, 1)) {
        if (!Player_TargetEnemy(this) && (!Player_TargetNonEnemy(this) || (func_80834B5C != this->upperActionFunc))) {
...
void func_8084193C(Player* this, PlayState* play) {
    ...
    if (!Player_TryActionChangeList(play, this, D_80854408, 1)) {
        ...
        if ((this->linearVelocity < 3.6f) && (sp3C < 4.0f)) {
            if (!Player_InZTargetingCombat(this) && Player_TargetNonEnemy(this)) {
                func_8083CB94(this, play);
            } else {
                func_80839F90(this, play);
            }
...
void func_8084227C(Player* this, PlayState* play) {
    ...
    if (!Player_TryActionChangeList(play, this, D_80854430, 1)) {
        ...
        if (!func_8083C484(this, &sp2C, &sp2A)) {
            if ((Player_TargetNonEnemy(this) && (sp2C != 0.0f) && (func_8083FD78(this, &sp2C, &sp2A, play) <= 0)) ||
                (!Player_TargetNonEnemy(this) && (func_8083FC68(this, sp2C, sp2A) <= 0))) {
                func_80839F90(this, play);
                return;
            }
...
s32 func_8084285C(Player* this, f32 arg1, f32 arg2, f32 arg3) {
    if ((arg1 <= this->skelAnime.curFrame) && (this->skelAnime.curFrame <= arg3)) {
        Player_UpdateMeleeWeaponState(this, (arg2 <= this->skelAnime.curFrame) ? 1 : -1);
        return 1;
    }
    ...
    if (this->unk_850 != 0) {
        ...
        if (this->unk_84F != 0) {
            if (!func_80842DF4(play, this)) {
                if (this->skelAnime.curFrame < 2.0f) {
                    Player_UpdateMeleeWeaponState(this, 1);
                }
            } else {
                this->unk_850 = 1;
                this->unk_84F = 0;
...
void func_8084411C(Player* this, PlayState* play) {
    ...
    if (gSaveContext.respawn[RESPAWN_MODE_TOP].data > 40) {
        this->actor.gravity = 0.0f;
    } else if (Player_InZTargetingCombat(this)) {
    ...
    if (func_80842964(this, play) == 0) {
        if (this->unk_850 != 0) {
            ...
            if (this->linearVelocity >= 7.0f) {
                if (randomBonk || ((this->actor.bgCheckFlags & ACTOR_BGFLAG_UNKNOWN) && (sWorldYawToTouchedWall < 0x2000)) ||
    ...
    if ((Message_GetState(&play->msgCtx) == TEXT_STATE_NONE) && (this->actor.category == ACTORCAT_PLAYER)) {
        ...
        if (!Player_InBlockingCsMode(play, this)) {
            if (this->stateFlags1 & PLAYER_STATE1_FIRST_PERSON) {
                ...
                } else if (!sp1C && (!(this->stateFlags1 & PLAYER_STATE1_SHIELDING) || Player_InZTargeting(this) ||
                                     !Player_IsChildWithHylianShield(this))) {
                    if ((!(this->stateFlags1 & PLAYER_STATE1_CLIMBING_LEDGE) && (sp20 <= 0) &&
                         (Player_InZTargetingCombat(this) ||
                          ((sFloorType != 7) && (Player_TargetNonEnemy(this) ||
                        ...
                        doAction = DO_ACTION_ATTACK;
                               ...
                               Player_InZTargeting(this) && (sp20 > 0)) {
...
void Player_ProcessSceneCollision(PlayState* play, Player* this) {
    ...
    if (floorPoly != NULL) {
        ...
        if (sConveyorSpeed != 0) {
            ...
            if (((sIsFloorConveyor == 0) && (this->actor.yDistToWater > 20.0f) &&
                 (this->currentBoots != PLAYER_BOOTS_IRON)) ||
                ((sIsFloorConveyor != 0) && (this->actor.bgCheckFlags & ACTOR_BGFLAG_ON_GROUND))) {
    ...
    if (this->actor.bgCheckFlags & 8) {
        ...
        if ((this->actor.bgCheckFlags & ACTOR_BGFLAG_UNKNOWN) && (sShapeYawToTouchedWall < 0x3000)) {
            CollisionPoly* wallPoly = this->actor.wallPoly;
...
void Player_UpdateCommon(Player* this, PlayState* play, Input* input) {
    ...
    if (this->stateFlags2 & PLAYER_STATE2_PAUSE_MOST_UPDATING) {
        ...
        if (!(this->skelAnime.moveFlags & 0x80)) {
            if (((this->actor.bgCheckFlags & ACTOR_BGFLAG_ON_GROUND) && (sFloorType == 5) && (this->currentBoots != PLAYER_BOOTS_IRON)) ||
...
void Player_Draw(Actor* thisx, PlayState* play2) {
    ...
    if (!(this->stateFlags2 & PLAYER_STATE2_DISABLE_DRAW)) {
        ...
        if ((this->csAction != 0) || (Player_InZTargetingCombat(this) && 0) || (this->actor.projectedPos.z < 160.0f)) {
            lod = 0;
        } else {
            lod = 1;
        }
...
void func_8084B1D8(Player* this, PlayState* play) {
    ...
    if ((this->csAction != 0) || (this->unk_6AD == 0) || (this->unk_6AD >= 4) || Player_TargetEnemy(this) ||
        (this->unk_664 != NULL) || !func_8083AD4C(play, this) ||
        (((this->unk_6AD == 2) && (CHECK_BTN_ANY(sControlInput->press.button, BTN_A | BTN_B | BTN_R) ||
                                   Player_TargetNonEnemy(this) || (!func_8002DD78(this) && !func_808334B4(this)))) ||
...
void func_8084B530(Player* this, PlayState* play) {
    ...
    } else if (!Player_InZTargetingCombat(this) && LinkAnimation_Update(play, &this->skelAnime)) {
        if (this->skelAnime.moveFlags != 0) {
            func_80832DBC(this);
            if ((this->targetActor->category == ACTORCAT_NPC) &&
...
void func_80851CA4(PlayState* play, Player* this, CsCmdActorAction* arg2) {
    if (LinkAnimation_Update(play, &this->skelAnime) &&
      (this->unk_850 == 0) && (this->actor.bgCheckFlags & ACTOR_BGFLAG_ON_GROUND)) {
